...
import { Box, Button, Container, Heading, HStack, Image, Link, Menu, MenuItem, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Spacer, Text, VStack } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <HStack>
  <Container sx={{"padding": "2rem", "backgroundColor": "#D9D8A9", "borderRadius": "12px"}}>
  <VStack>
  <Image src={`https://placehold.co/350`}/>
  <VStack sx={{"width": "100%"}}>
  <HStack>
  <Text>
  {`Producto`}
  ...
  <HStack>
  <Text>
  {`Ingresa aqui para solicitar tus pedidos personalizados`}
</Text>
  <Link as={NextLink} href={`#personalizados`}>
  {`Pedidos Personalizados`}
</Link>
</HStack>
</VStack>
